...
TEST(DifferentialDriveWheelVelocitiesTest, UnaryMinus) {
  const wpi::math::DifferentialDriveWheelVelocities speeds{1.0_mps, 0.5_mps};

  const wpi::math::DifferentialDriveWheelVelocities result = -speeds;
...
TEST(DifferentialDriveWheelVelocitiesTest, Multiplication) {
  ...
  const wpi::math::DifferentialDriveWheelVelocities result = speeds * 2;
